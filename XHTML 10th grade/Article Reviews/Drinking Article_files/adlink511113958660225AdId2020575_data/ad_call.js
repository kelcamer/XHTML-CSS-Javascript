...
(function() {
	...
	function setLayoutDefaults(w, doc) {
		...
		if (w.turn_ad_layout != "0x0") {
				...
				w.turn_ad_layout_height = 120;
					...
					if(w.turn_ad_layout == "300x50") {
				w.turn_ad_layout_width = 300;
				w.turn_ad_layout_height = 50;
			}
					if(w.turn_ad_layout == "320x50") {
				w.turn_ad_layout_width = 320;
				w.turn_ad_layout_height = 50;
			}
					if(w.turn_ad_layout == "216x36") {
				w.turn_ad_layout_width = 216;
				w.turn_ad_layout_height = 36;
			}
					if(w.turn_ad_layout == "168x28") {
				w.turn_ad_layout_width = 168;
				w.turn_ad_layout_height = 28;
			}
					if(w.turn_ad_layout == "120x20") {
				w.turn_ad_layout_width = 120;
				w.turn_ad_layout_height = 20;
			}
					if(w.turn_ad_layout == "849x111") {
				w.turn_ad_layout_width = 849;
				w.turn_ad_layout_height = 111;
			}
					if(w.turn_ad_layout == "180x460") {
				w.turn_ad_layout_width = 180;
				w.turn_ad_layout_height = 460;
			}
				}
	...
	function setAdUrl(w, doc) {
        ...
        addAdUrlParam(w, "liid", w.turn_li_manual_id);
