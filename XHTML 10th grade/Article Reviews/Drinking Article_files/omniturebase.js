...
function doLoad() {
	...
	if (null == sess) {
		 ...
		 img_v2.setAttribute('src', 'http://segmentmap.gannett.gcion.com/asp/segmentmapweb/segmentmapbeacon_V2.ashx');
...
s_ut.eVar20=window.location.host+window.location.pathname;
